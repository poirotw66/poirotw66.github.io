...
export const PAPER_READING_PATHS: PaperReadingPath[] = [
  ...
  },
  {
    ...
    slugs: [
      ...
      '47-reva-reusable-evidence-views',
      '48-vikingrag-structured-document-retrieval',
      '50-evoontology-self-evolving-ontology',
      '53-agentic-rag-partial-answer-prediction',
      '55-ragsieve-rag-poison-detection',
      ...
      '70-rat-unified-bayesian-rag-evaluation',
      '72-when-is-complex-chunking-worth-it',
    ],
  },
  {
    id: 'agent-systems',
    ...
    slugs: [
      ...
      '44-draco-dynamic-rubrics',
      '45-continuity-security-context-contracts',
      '46-k-bench-agentic-unlearning',
      '49-tool-calls-workflows-fail',
      '51-plan-injection-cot-monitoring',
      '52-after-party-agent-skill-ecosystem',
      '54-silentprobe-silent-api-failures',
      ...
      '66-aport-vault-payment-agent-authorization',
      '67-trajectory-aware-benchmark-subset-selection',
      '68-mobilecybench-executable-security-probes',
      '69-xyeval-agents-say-yes-to-bad-advice',
