...
export const TOPIC_CLUSTERS: readonly TopicCluster[] = [
  {
    ...
    childSlugs: [
      ...
      '09-harness-design-long-running-apps',
      '10-effective-harnesses-for-long-running-agents',
      '11-harness-engineering',
      '13-harness-engineering-reading-map',
      '14-martin-fowler-harness-engineering-review',
      '15-langchain-agent-harness-anatomy',
      '16-mitchell-hashimoto-harness-origin',
      '17-anthropic-parallel-c-compiler-agents',
      '18-phil-schmid-agent-harness-2026',
      '19-parallel-ai-what-is-agent-harness',
      '20-ignorance-ai-harness-playbook',
      '21-humanlayer-skill-issue-harness',
      '29-agent-era-skills-subagents-commands-hooks',
      '36-gitlab-orbit',
      '45-google-colab-cli',
      '49-the-new-sdlc-with-vibe-coding',
      '52-openai-prompting-guidance-gpt-5-6-sol',
      '69-ornith-1-0-self-scaffolding-llm',
      '70-takt-agent-coordination-topology',
      '71-context-engineering-claude-5',
      '72-openai-gpt-5-6-prompting-rules',
      '74-agentescapebench-ood-tool-reasoning',
      '75-robust-rl-small-language-model-agents',
  ...
  },
  {
    ...
    childSlugs: [
      ...
      '80-open-knowledge-format-v02-upgrade',
      '35-graph-rag-llm',
