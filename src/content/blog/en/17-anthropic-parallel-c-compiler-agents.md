...
| [Blog 10](/blog/10-effective-harnesses-for-long-running-agents/) | This Article |
|----------------------------------|------|
...
This shares the same language as the **computational sensors** in [Fowler 14](/blog/14-martin-fowler-harness-engineering-review/) and the mechanized boundaries in [OpenAI 11](/blog/11-harness-engineering/): **mechanically verifiable invariants**.
...
The harness **should not** spew thousands of lines of useless output into the context—this is consistent with the tool output offloading in [LangChain 15](/blog/15-langchain-agent-harness-anatomy/) and the "silent on success, noisy on failure" principle in [HumanLayer 21](/blog/21-humanlayer-skill-issue-harness/).
...
This fills the **behaviour harness** gap in [Fowler 14](/blog/14-martin-fowler-harness-engineering-review/) and completes the **E2E observation** triangle in [OpenAI 11](/blog/11-harness-engineering/): **the larger the scale, the less verification philosophy can rely solely on unit tests**.
...
- [Harness Reading Map 13](/blog/13-harness-engineering-reading-map/) (List **#6**)  
- Next article: [18 Phil Schmid — 2026 and durability](/blog/18-phil-schmid-agent-harness-2026/)
