...
- Target Audience: Creators who aren't good at drawing, want to try LINE stickers as a side project, but are intimidated by the publishing process.
- Mindset Shift: Stop focusing on drawing skills, and focus on "who will use it," "in what situations," and "how to efficiently finish 16 stickers."
- Core Implementation: First, lock in the audience and characters, then list at least 16 common chat phrases, and finally decide on the visual style and tools.
- Drawing Strategy: Use geometric figures, simple animals, processed photos, or AI drafts to unify a set of styles, without pursuing exquisite details.
- Process Optimization: Leave resizing, naming, and packaging to tools; focus only on selecting and adjusting images.
- Launch Essentials: Avoid common reasons for rejection like messy titles, sensitive content, and image edge flaws to pass the review smoothly.
- Future Operations: Treat the first set as practice to learn the complete launch process, and experiment with multiple topics to accumulate long-tail income and IP assets.

## Why "Unorthodox"? Breaking Down the Real Barriers

When it comes to LINE stickers, many people's first reaction is:

> "My drawing skills aren't good enough, forget it."

This statement actually confuses two things:

- **How good the drawing is** (Technical barrier)
- **Whether it can be published and if people will buy it** (Commercial barrier)

The route this article will take you on is an "unorthodox" one:

- Don't strive to be an illustrator, and don't compete with professional artists on details.
...
So many people get stuck at:

- After genuinely drawing 8 to 40 images, they are exhausted and have no energy left for formatting.
...
As for the drawing aspect, I would suggest you:

- Use **simple geometric shapes + limited color palettes** to build characters (round face, square body, simple lines for limbs).
- Use **processed photos, AI generation, or stock assets** as a base, then unify the style.
- What truly needs to be accumulated over time is not brushstrokes, but **sensitivity to topics and usage scenarios**.
...
The following route assumes you have no background as an illustrator but are willing to put in the effort to create your first set of stickers.

### Step 1: First Decide "Who" Will Use These Stickers

Don't open your drawing software yet. Get a pen and paper, and answer three questions:

1. Who is this set of stickers for? (The more specific, the better)
2. What emotions or keywords do they use most often in daily chats?
3. What is the vibe this set of stickers wants to convey? (Furious, lazy, healing, sunny...)

Example:

- Target Audience: Office workers constantly chased by KPIs.
- Key Emotions: Exhausted, endless meetings, broke at the end of the month, pretending to be optimistic.
- Vibe: Smiling on the outside, dark humor of a collapsing inner world.

This step determines the direction of all your subsequent images and text.

> This article uses the unorthodox little cat from the beginning of the article as an example, creating a set of stickers with the theme of a "Chuunibyou (Eighth-Grader Syndrome) Kitten".

### Step 2: List 16 Common Situational Phrases

Create a list with at least 16 conversational phrases that are "common, funny, and practical" for your target audience, such as:

| No. | Action Description (Bilingual suggestion) | Visual Focus |
|------|------------------------|----------|
| 01 | Tyrant's Eye Awakening: The kitten covers its left eye with one paw, a heterochromatic purple light shining through its fingers. | Heterochromia, mysterious light, close-up |
| 02 | Seal Released: The kitten looks down, tearing at the bandage on its paw with its teeth, surrounded by illusory black particles. | Bandage, dark aura, madness |
| 03 | Incantation of Fate: Paws pressed together (or facing each other like claws), an unstable little shadow ball condensing in the middle. | Magic ball, dark energy, focus |
| 04 | Void Gaze: Sitting high up looking down at the masses, background is a giant blood-red full moon, a cape (rag) fluttering in the wind. | Red moon, cape, top-down view |

*(The table above only lists the first 4 examples. When implementing, please prepare at least 16 phrases.)*

Principles:

- Prioritize phrases **you would actually use yourself**.
- Avoid overly long sentences; reading burden increases in chat bubbles.
- Mix and match in the same sticker set: questions + roasting + inner monologue + strong emotional words (like "breakdown").

### Step 3: Use LLMs to Assist in Generating Situational Phrases

You can brainstorm the phrases yourself or use LLMs to help generate them; this article uses Gemini generating 16 situational phrases as an example.

![01_gemini_prompt](/blog/03-line-sticker-quick-launch/01_gemini_prompt.webp)

### Step 4: "Outsourcing Drawing" —— Use Models to Generate Images

Following the situational descriptions generated by Gemini above, enter the following prompt into the chat:
```
Based on the prompt above, generate a 4x4 sprite sheet, without adding text, with a solid green screen background for easy background removal, and no borders.
```
Generated images:
...
- Use scripts/batch processing you are familiar with (like ImageMagick, Photoshop Actions, etc.).
- Or refer to the open-source tools introduced on this site:
  - [line-sticker-packer: One-click resizing and packaging](/stickers/tools/) one of the tools introduced.
  - [sprite-animator, stickermind related workflows](/stickers/tools/) can also help handle asset slicing and management.
...
### Step 6: Launch on the LINE Creators Market, Avoid Common Pitfalls
