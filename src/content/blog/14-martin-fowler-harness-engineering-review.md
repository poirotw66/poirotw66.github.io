...
這直接補上 [OpenAI 11](/blog/11-harness-enginnering/) 與 [Anthropic 長任務 10](/blog/10-effective-harnesses-for-long-running-agents/) 之間的缺口：前者強調 repo 與 E2E 可重現，后者強調 feature list 與瀏覽器自動化，但**「行為 harness 的通解」**仍待業界共識。
