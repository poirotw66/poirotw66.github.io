...
tldr:
  - "OpenAI Realtime API + Gemini Live + MCP: ChatGPT-like voice assistant with selectable models, supporting real-time voice, streaming responses, dark/light mode, and tool-augmented…"
