...
image: "/paperReading/05_RAG-without-Forgetting/image_1.jpg"
field: "NLP"
...
![QE, KE 與 ERM 的核心概念對比](/paperReading/05_RAG-without-Forgetting/image_1.jpg)
*圖表解析：*
...
![ERM 系統架構與運作流程](/paperReading/05_RAG-without-Forgetting/image_2.jpg)
*圖表解析（對應圖中 a, b, c 三階段）：*
...
![效能與延遲的權衡對比](/paperReading/05_RAG-without-Forgetting/image_3.jpg)
*圖表解析：*
...
**B. 對各種擴展方法的泛化能力**
![ERM 在不同擴展方法與檢索器上的增益](/paperReading/05_RAG-without-Forgetting/image_6.jpg)
*圖表解析：*
