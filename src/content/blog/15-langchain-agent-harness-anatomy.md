...
> **花花的一句話**
>
> 喵！如果不給模型配備各種工具，它就只是一個會說話的大腦。加上沙箱、記憶和指令執行，才能變成真正會工作的小幫手！
>
> **花花的工程提醒**
>
> 裸模型並非 Agent，必須由期望行為反推所需 Harness 元件（如沙箱環境、Bash 執行、記憶機制與 Context 管理）。透過產品化這些 primitive，才能將模型能力轉化為可交付的工作引擎。
