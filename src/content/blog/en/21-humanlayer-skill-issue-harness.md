...
Skills, MCP, Sub-agents, Memory, and AGENTS.md seem scattered on the surface, but they are actually the same **configuration surface**—the runtime/peripheral equipment of the Agent. This article wraps up Phase 2 of the [Reading Map 13](/blog/13-harness-engineering-reading-map/) (list **#10**), narrowing down the strategy of [Playbook 20](/blog/20-ignorance-ai-harness-playbook/) into **five actionable knobs**.
...
| Risk of overfitting | [Terminal Bench](/blog/15-langchain-agent-harness-anatomy/): Opus 4.6 is around **#33** in Claude Code, but jumps to around **#5** when changing Harness (also cited by Schmid/LangChain) |

**Conclusion**: It is still worth engineering a Harness for **your repo**, rather than relying entirely on defaults—especially for brownfield, internal tools, and compliance boundaries. Parallel to [Schmid 18](/blog/18-phil-schmid-agent-harness-2026/)'s "build to delete": What you customize are **rules and feedback**, not eternal, heavy orchestration.
...
This **does not contradict** [OpenAI 11](/blog/11-harness-engineering/)'s "AGENTS as an index", [Playbook 20](/blog/20-ignorance-ai-harness-playbook/)'s "update after every mistake", or [Hashimoto 16](/blog/16-mitchell-hashimoto-harness-origin/)'s "every line corresponds to a failure"—the difference lies in **quality, length, and update cadence**.
...
Related to [Fowler 14](/blog/14-martin-fowler-harness-engineering-review/)'s feedforward guides: Skills are **lazy-loaded guides**.
...
Unlike [Carlini 17](/blog/17-anthropic-parallel-c-compiler-agents/)'s **16 containers fighting over the repo**: Sub-agents are **isolated within a single flow**, not parallel compilers with multiple writers.
...
This is in the same family as [Carlini 17](/blog/17-anthropic-parallel-c-compiler-agents/)'s test log design and [Fowler 14](/blog/14-martin-fowler-harness-engineering-review/)'s sensors.
...
Compared to [Playbook 20](/blog/20-ignorance-ai-harness-playbook/)'s slop threshold: back-pressure is **the first layer of automated bullshit detection**; human review is the second layer.
...
With [Fowler 14](/blog/14-martin-fowler-harness-engineering-review/): **Bias towards shipping, rather than Harness hoarding**.
...
|-------|------|----------------|
| Index | [13 Reading Map](/blog/13-harness-engineering-reading-map/) | #10 In-depth read |
| Phase 1 | [10](/blog/10-effective-harnesses-for-long-running-agents/), [11](/blog/11-harness-engineering/), [14–16](/blog/14-martin-fowler-harness-engineering-review/) | Theory and organizational cases |
| Phase 2 | [17–20](/blog/17-anthropic-parallel-c-compiler-agents/) | Stress testing, strategy, popularization, playbook |
...
HumanLayer's title **Skill Issue** is a pun: it's not an insult to the model, but a reminder that **the skill tree points belong in the configuration surface**. Five types of knobs + back-pressure break down the "building environments" from the [Ignorance Playbook](/blog/20-ignorance-ai-harness-playbook/) into **repo files and hooks you can change tomorrow**. If you can only read one article from Phase 2 as a manual, **21 is the closest to a daily driver**; if you want strategy and industry convergence, start with [18](/blog/18-phil-schmid-agent-harness-2026/) and [20](/blog/20-ignorance-ai-harness-playbook/).
...
- [20 Ignorance Playbook](/blog/20-ignorance-ai-harness-playbook/) · [19 Parallel.ai Explained](/blog/19-parallel-ai-what-is-agent-harness/)
